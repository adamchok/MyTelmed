                    ...
                    <Card className="shadow-lg border-0 bg-white h-full" styles={{ body: { padding: "16px" } }}>
                        <div className="text-center">
                            ...
                            <div className="relative inline-block mb-6">
                                <Avatar
                                    src={pharmacist?.profileImageUrl}
                                ...
                                >
                                    <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-purple-700 rounded-full flex items-center justify-center cursor-pointer hover:bg-purple-800 transition-colors duration-200 shadow-lg border-2 border-white">
                            ...
                            <div className="mt-6">
                                <Badge
                                    status={getAccountStatus(pharmacist?.enabled || false).status}
                                    text={
                                        <Text className="text-xs sm:text-sm">
                                            Account {getAccountStatus(pharmacist?.enabled || false).text}
                                        </Text>
                                    }
                                />
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Text strong className="text-xs sm:text-sm">
                                    {pharmacist?.createdAt ? formatEpochDate(pharmacist.createdAt) : "N/A"}
                                </Text>
                            </div>
                            <div className="flex items-center justify-between">
                    ...
                    <Card className="shadow-lg border-0 bg-white h-full" styles={{ body: { padding: "16px" } }}>
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center">
                                <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-purple-700 mr-2 sm:mr-3" />
                            ...
                            <Row gutter={[16, 16]}>
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        label={
                                            <span className="text-xs sm:text-sm font-medium text-gray-700 flex items-center">
                                                <User className="mr-2 text-purple-700" size={16} strokeWidth={2.2} />
                                                Full Name
                                            </span>
                                        }
                                        name="name"
                                    ...
                                    >
                                        <Input
                                            ...
                                            className="h-10 sm:h-12 rounded-xl border-gray-200 hover:border-purple-700 focus:border-purple-700 transition-colors"
                                            size="large"
                                        />
                                    </Form.Item>
                                </Col>
                                ...
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        label={
                                            <span className="text-xs sm:text-sm font-medium text-gray-700 flex items-center">
                                                <Mail className="mr-2 text-purple-700" size={16} strokeWidth={2.2} />
                                                Email Address
                                            </span>
                                        }
                                        name="email"
                                ...
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        label={
                                            <span className="text-xs sm:text-sm font-medium text-gray-700 flex items-center">
                                                <Phone className="mr-2 text-purple-700" size={16} strokeWidth={2.2} />
                                                Phone Number (without hyphens)
                                                <Tooltip title="Example: 0112223333">
                                                    <Info className="text-purple-700 ml-2 cursor-pointer hover:text-purple-800 transition-colors" />
                                                </Tooltip>
                                            </span>
                                        }
                                        name="phone"
                                ...
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        label={
                                            <span className="text-xs sm:text-sm font-medium text-gray-700 flex items-center">
                                                <Calendar className="mr-2 text-purple-700" size={16} strokeWidth={2.2} />
                                                Date of Birth
                                            </span>
                                        }
                                        name="dateOfBirth"
                        ...
                        {!isEditing && (
                            <div className="md:hidden flex justify-center py-4 sm:py-6 border-t border-gray-100">
                                <Button
                                    ...
                                    onClick={onToggleEditMode}
                                    size="middle"
                                    className="w-full max-w-xs bg-purple-700 hover:bg-purple-800 border-purple-700"
                                >
                                    Edit Profile
                                </Button>
                            </div>
                    ...
                    <Col span={24}>
                        <Card className="shadow-lg border-0 bg-white" styles={{ body: { padding: "16px" } }}>
                            <div className="flex items-center mb-6">
                                <Building2 className="w-5 h-5 sm:w-6 sm:h-6 text-purple-700 mr-2 sm:mr-3" />
                                <Title level={4} className="m-0 text-gray-800 text-base sm:text-lg">
                                    My Facility
                                </Title>
                            </div>
                            ...
                            <Row gutter={[24, 24]} align="top">
                                ...
                                <Col xs={24} sm={8} md={6} lg={4}>
                                    <div className="flex justify-center sm:justify-start">
                                        <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-xl overflow-hidden border-2 border-purple-100 bg-gray-50 flex items-center justify-center">
                                            {pharmacist.facility.thumbnailUrl ? (
                                                <Image
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="space-y-1">
                                                            <Text strong className="text-xs sm:text-sm block">
                                                                {pharmacist.facility.address}
                                                            </Text>
                                                            <Text className="text-gray-600 text-xs sm:text-sm">
                                                                {pharmacist.facility.city}, {pharmacist.facility.state}
                                                            </Text>
                                                        </div>
                                                    </div>
                                                </div>
