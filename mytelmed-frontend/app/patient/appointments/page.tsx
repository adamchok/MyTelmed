...
//             label:
//                 labels[patientId] || dummyAppointments.find((a) => a.patientId === patientId)?.patientName || patientId,
//             value: patientId,
//         }));
//     }, []);
...
//             filtered = filtered.filter((appointment) => filters.status?.includes(appointment.status));
//         }
...
//             filtered = filtered.filter((appointment) => appointment.doctorName.toLowerCase().includes(doctorName));
//         }

//         // Filter by facility
//         if (filters.facility) {
//             const facility = filters.facility.toLowerCase();
//             filtered = filtered.filter((appointment) => appointment.facilityName.toLowerCase().includes(facility));
//         }
...
//             .filter((appointment) => appointment.status === "scheduled" && !isDateInPast(appointment.appointmentDate))
//             .sort((a, b) => {
