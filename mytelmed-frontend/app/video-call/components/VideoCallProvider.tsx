...
import { StreamVideo, StreamVideoClient, StreamVideoClientOptions, User } from "@stream-io/video-react-sdk";
...
export function VideoCallProvider({
    appointmentId,
    children,
}: Readonly<{ appointmentId: string; children: ReactNode }>) {
    ...
    useEffect(() => {
        const initializeVideoCall = async () => {
            try {
                ...
                //
                const response = await VideoCallApi.createVideoCallAndGetStreamUserAndToken(appointmentId);
