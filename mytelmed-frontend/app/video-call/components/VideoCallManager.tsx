...
import { useStreamVideoClient, StreamCall, Call, StreamTheme } from "@stream-io/video-react-sdk";
import MeetingRoom from "./MeetingRoom";
import MeetingSetup from "./MeetingSetup";
import { AppointmentDto } from "../../api/appointment/props";
import VideoCallApi from "@/app/api/videocall";
import { VideoCallDto } from "@/app/api/videocall/props";
...
export default function VideoCallManager({ appointment, onCallEnd }: VideoCallManagerProps) {
    ...
    const initializeCall = useCallback(async () => {
        ...
        try {
            ...
            const streamCall = client.call(meetingData.streamCallType, meetingData.streamCallId);
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <Card className="w-full max-w-md shadow-xl border border-gray-200">
                    <div className="text-center py-8">
                        ...
                        <Progress percent={connectionProgress} strokeColor="#1890ff" className="mb-4" />

                        <Text className="text-gray-600">Setting up your video call environment...</Text>

                        <div className="mt-6">
                            <Steps direction="vertical" size="small" current={Math.floor(connectionProgress / 25)}>
                                <Step title="Connecting to server" icon={<WifiOutlined />} />
                                <Step title="Initializing video" icon={<VideoCameraOutlined />} />
                    ...
                    <div className="text-center py-8">
                        ...
                        <Space direction="vertical" size="large" className="w-full">
                            <Paragraph className="text-gray-600">
                                We encountered an issue while trying to connect to your video call. This could be due to
                        ...
                        >
                            <Space direction="vertical" size="large" className="w-full">
                                ...
                                <div>
                                    ...
                                    <Tag color={getStatusColor(appointment.status)} className="px-3 py-1 text-sm">
                                        <Badge
                                            status={connectionStatus === "connected" ? "success" : "processing"}
                                            className="mr-2"
                                        />
                                ...
                                {appointment.reasonForVisit && (
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <Text className="text-gray-600">{appointment.reasonForVisit}</Text>
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="text-center py-8">
                                <div className="mb-6">
                                    ...
                                    <Text className="text-gray-600 text-lg">
                                        Start your consultation with Dr. {appointment.doctor?.name}
                                    </Text>
                                </div>
                                ...
                                {canCreateCall() && (
                                    <div className="mt-8 pt-6 border-t border-gray-200">
                                        ...
                                        <Space direction="vertical" size="small" className="text-left">
