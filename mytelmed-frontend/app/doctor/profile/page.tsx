...
import { Doctor, UpdateDoctorProfileRequest } from "@/app/api/doctor/props";
...
const Profile = () => {
    ...
    const fetchProfile = useCallback(async () => {
        try {
            ...
            if (response.data?.isSuccess && response.data.data) {
                ...
                setProfileData((prev) => ({ ...prev, doctor }));
    ...
    const handleImageUpload = async (file: File) => {
        try {
            ...
            const response = await DoctorApi.updateDoctorProfileImage(file);
