...
export default function CreatePasswordPage() {
    ...
    const onFinish = async (values: CreatePasswordFormProps) => {
        ...
        try {
            setLoading(true);
            const response = await ResetApi.resetPassword(token as string, resetPasswordRequest);
            ...
            <div className="relative z-10 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-blue-900/20 p-3 sm:p-4 md:p-6 lg:p-8">
                    <div className="text-center mb-4 sm:mb-6">
                        ...
                        <Text className="text-gray-500 text-xs sm:text-sm">Please enter your new password below.</Text>
                    </div>
                    <Form
                        form={form}
                        layout="vertical"
