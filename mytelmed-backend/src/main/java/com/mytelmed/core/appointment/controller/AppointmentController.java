...
public class AppointmentController {
    ...
    public ResponseEntity<ApiResponse<Void>> bookAppointment(
        ...
        log.info("Received request to book appointment for account with ID: {}", account.getId());
    ...
    public ResponseEntity<ApiResponse<Void>> updateAppointment(
        ...
        log.info("Received request to update appointment with ID: {}", appointmentId);

        appointmentService.update(account, appointmentId, request);
        return ResponseEntity.ok(ApiResponse.success("Appointment updated successfully"));
    }
