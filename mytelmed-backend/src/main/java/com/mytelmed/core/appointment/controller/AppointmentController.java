...
public class AppointmentController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<UUID>> bookAppointment(
        ...
        UUID appointmentId = appointmentService.book(account, request);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(appointmentId, request.consultationMode() + " appointment booked successfully"));
    }
