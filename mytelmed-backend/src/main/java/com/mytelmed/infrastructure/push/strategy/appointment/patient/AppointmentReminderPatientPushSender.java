...
@Component
public class AppointmentReminderPatientPushSender extends BasePushNotificationStrategy {

    public AppointmentReminderPatientPushSender(
    ...
    protected String buildBody(Map<String, Object> variables) {
        ...
        return String.format("Your appointment with %s is starting at %s!", providerName, formattedDateTime);
    }
