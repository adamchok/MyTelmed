...
@Slf4j
@Component
public class DeliveryCreatedEmailSender extends BaseEmailSenderStrategy {
    public DeliveryCreatedEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.DELIVERY_CREATED;
    }
    ...
    protected String buildSubject(Map<String, Object> variables) {
        return "MyTelmed - Medication Delivery Confirmed";
    }
