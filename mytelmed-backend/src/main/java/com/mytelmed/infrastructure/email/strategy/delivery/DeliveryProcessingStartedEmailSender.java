...
@Slf4j
@Component
public class DeliveryProcessingStartedEmailSender extends BaseEmailSenderStrategy {
    public DeliveryProcessingStartedEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.DELIVERY_PROCESSING_STARTED;
    }

    @Override
    protected String getTemplatePath() {
        return "delivery/processing-started";
    }
    ...
    protected String buildSubject(Map<String, Object> variables) {
        ...
        if ("HOME_DELIVERY".equals(deliveryMethod)) {
            return "MyTelmed - Your Medication Delivery is Being Prepared";
        } else {
            return "MyTelmed - Your Medication is Being Prepared for Pickup";
        }
    }
