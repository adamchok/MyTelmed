...
@Slf4j
@Component
public class AppointmentConfirmationDoctorEmailSender extends BaseEmailSenderStrategy {
    public AppointmentConfirmationDoctorEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.APPOINTMENT_CONFIRMATION_DOCTOR;
    }

    @Override
    protected String getTemplatePath() {
        return "appointment/doctor/confirm";
    }

    @Override
    protected String buildSubject(Map<String, Object> variables) {
        return "MyTelmed - New Appointment Confirmation";
    }
