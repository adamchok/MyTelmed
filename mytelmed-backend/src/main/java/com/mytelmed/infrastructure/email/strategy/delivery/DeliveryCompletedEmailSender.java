...
@Slf4j
@Component
public class DeliveryCompletedEmailSender extends BaseEmailSenderStrategy {
    public DeliveryCompletedEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.DELIVERY_COMPLETED;
    }
    ...
    protected String buildSubject(Map<String, Object> variables) {
        ...
        if ("PICKUP".equals(deliveryMethod)) {
            return "MyTelmed - Medication Successfully Picked Up";
        } else {
            return "MyTelmed - Medication Successfully Delivered";
        }
    }
