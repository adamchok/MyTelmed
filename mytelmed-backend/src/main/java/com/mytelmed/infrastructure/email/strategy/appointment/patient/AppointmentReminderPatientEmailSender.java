...
@Slf4j
@Component
public class AppointmentReminderPatientEmailSender extends BaseEmailSenderStrategy {
    public AppointmentReminderPatientEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.APPOINTMENT_REMINDER_PATIENT;
    }

    @Override
    protected String getTemplatePath() {
        return "appointment/patient/reminder";
    }

    @Override
    protected String buildSubject(Map<String, Object> variables) {
        return "MyTelmed - Appointment Reminder";
    }
