...
@Slf4j
@Component
public class DeliveryCancelledEmailSender extends BaseEmailSenderStrategy {
    public DeliveryCancelledEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.DELIVERY_CANCELLED;
    }
    ...
    protected String buildSubject(Map<String, Object> variables) {
        return "MyTelmed - Medication Delivery Cancelled";
    }
    ...
    protected void validateRequiredVariables(Map<String, Object> variables) {
        ...
        validateRequiredVariable(variables, "cancellationReason", "Cancellation reason is required");
