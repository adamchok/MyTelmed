...
@Slf4j
@Component
public class AppointmentConfirmationPatientEmailSender extends BaseEmailSenderStrategy {
    public AppointmentConfirmationPatientEmailSender(
    ...
    public EmailType getEmailType() {
        return EmailType.APPOINTMENT_CONFIRMATION_PATIENT;
    }

    @Override
    protected String getTemplatePath() {
        return "appointment/patient/confirm";
    }

    @Override
    protected String buildSubject(Map<String, Object> variables) {
        return "MyTelmed - Appointment Confirmed";
    }
